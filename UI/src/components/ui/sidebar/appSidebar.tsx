            ...
            <SidebarGroupContent>
              {mails.map((mail) => (
                <a
                  href="#"
                  key={mail.email}
                  className="flex text-primary hover:text-danger flex-col items-start gap-2 whitespace-nowrap border-b p-4 text-sm leading-tight last:border-b-0"
                >
                  ...
                  <span className="line-clamp-2 w-[260px] whitespace-break-spaces text-xs font-light">
                    {mail.teaser}
                  </span>
                </a>
              ))}
